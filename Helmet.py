...
# 這一行程式碼，是提醒我們的 LINE 機器人，當收到 LINE 的 MessageEvent (訊息事件)，
# 而且信息是屬於 ImageMessage (圖片訊息)的時候，就執行下列程式碼。

def handle_message(event):
# 定義一個叫做handle_message的函數，該函數會接收一個 LINE 發送過來的資訊，
# 並貼上event的標籤，方便後續的操作。
    ...
    name_img = 'C:\\Users\\Tibame\\Desktop\\Azure\\aaa.jpg'
    message_content = line_bot_api.get_message_content(event.message.id)#我們可以透過這個ID下載到使用者傳送的檔案
    
    with open(name_img, 'wb') as fd:
        for chunk in message_content.iter_content():#根據linebot官方文件可以取出訊息內容
            fd.write(chunk)
        # 輸入customvision的所需金鑰
        ...
        base_image_location = "C:\\Users\\Tibame\\Desktop\\\Azure\\"
        ...
        img_path ='C:\\Users\\Tibame\\Desktop\\\Azure\\aaa.jpg'
       ...
       # 當圖片展示時的視窗名稱
        ...
        #save image to file
        cv2.imwrite('C:\\Users\\Tibame\\Desktop\\Azure\\output.jpg', image)        
        
        #imgur
        CLIENT_ID = "030a355399d5d25"
        PATH = "C:\\Users\\Tibame\\Desktop\\output.jpg" #A Filepath to an image on your computer"
